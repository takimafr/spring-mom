 ...
 * @see MOMClient
 */
public class MOMClientGozirra extends MOMClient {
	 ...
	 * @see MOMClient
	 */
	public MOMClientGozirra(String hostname, int port, String username, String password) {
	 ...
	 * @see MOMClient
	 */
	public MOMClientGozirra(String hostname, int port, String username, String password, boolean autoconnect) {
